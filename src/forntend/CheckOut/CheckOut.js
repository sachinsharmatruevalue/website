                                ...
                                <div className="ec-checkout-inner">
                                    <div className="ec-checkout-wrap margin-bottom-30">
                                        ...
                                        <div className="ec-checkout-block ec-check-login">
                                            <h3 className="ec-checkout-title">Returning Customer</h3>
                                                                ...
                                                                <ul className="ec-opt-swatch ec-change-img">
                                                                    <li className="active">
                                                                        <a
                                                                            ...
                                                                            data-tooltip="Gray"
                                                                        >
                                                                            <span style={{ backgroundColor: "#6d4c36" }} />
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a
                                                                            ...
                                                                            data-tooltip="Orange"
                                                                        >
                                                                            <span style={{ backgroundColor: "#ffb0e1" }} />
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a
                                                                            ...
                                                                            data-tooltip="Green"
                                                                        >
                                                                            <span style={{ backgroundColor: "#8beeff" }} />
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a
                                                                        ...
                                                                        >
                                                                            <span style={{ backgroundColor: "#74f8d1" }} />
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                                ...
                                                                <ul className="ec-opt-swatch ec-change-img">
                                                                    ...
                                                                    <li>
                                                                        <a
                                                                            ...
                                                                            data-tooltip="Orange"
                                                                        >
                                                                            <span style={{ backgroundColor: "#fac7f3" }} />
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a
                                                                            ...
                                                                            data-tooltip="Green"
                                                                        >
                                                                            <span style={{ backgroundColor: "#c5f1ff" }} />
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                        ...
                                        <div className="ec-checkout-del">
                                            ...
                                            <form action="#">
                                                <span className="ec-del-option">
                                                    <span>
                                                        <span className="ec-del-opt-head">Free Shipping</span>
                                                        <input
                                                            type="radio"
                                                            id="del1"
                                                            name="radio-group"
