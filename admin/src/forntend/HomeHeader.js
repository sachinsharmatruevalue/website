                           ...
                           <div className="ec-header-bottons">
                              ...
                              <button className="dropdown-toggle" data-bs-toggle="dropdown">
                                 ...
                                 <ul className="dropdown-menu dropdown-menu-right">
                                    <Link to='/register'><li><a className="dropdown-item" href="register.html">Register</a></li></Link>
                                    <Link to='/checkout'><li><a className="dropdown-item" href="checkout.html">Checkout</a></li></Link>
                                    <Link to='/login'><li><a className="dropdown-item" href="login.html">Login</a></li></Link>
                                    <Link to='/user-profile'><li><a className="dropdown-item" href="user.html">UserProfile</a></li></Link>
                                 </ul>
                              </div>
                              {/* Header User End */}
