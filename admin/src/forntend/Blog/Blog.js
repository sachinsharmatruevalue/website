                                    ...
                                    <div className="ec-blog-inner text-center pt-4 pb-4">
                                       ...
                                       <div className="ec-blog-content">
                                          ...
                                          <div className="ec-blog-date">
                                                By <span>{blog.author}</span>  Date :{new Date(blog.createdAt).toLocaleString()}
                                                </div>
                                          <div className="ec-blog-desc">{blog.content.substring(0, 100)}...</div>
                                          <div className="ec-blog-btn">
                                       
                        
                                             <Link to={`/blog/${btoa(blog._id).replace(/\//g, "_").replace(/\+/g, "-")}`} className="btn btn-primary">Read More</Link>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
